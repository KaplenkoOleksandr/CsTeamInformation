...
namespace CsTeamInformation.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(MyFirstDBContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Name,Nickname,ImageFile,TeamId")] Players players)
        {
