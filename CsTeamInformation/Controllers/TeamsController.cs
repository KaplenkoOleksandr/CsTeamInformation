...
namespace CsTeamInformation.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public TeamsController(MyFirstDBContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("Name,ImageFile,CorporationId")] Teams teams)
        {
